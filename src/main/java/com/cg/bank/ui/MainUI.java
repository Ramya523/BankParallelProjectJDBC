...
import com.cg.bank.service.UserEntryService;
import com.cg.bank.service.UserEntryServiceImpl;
import com.cg.bank.utility.InvalidAadhaarNoException;
import com.cg.bank.utility.InvalidMobileNoException;
...
public class MainUI {
	...
	private static int setInfo() {
		...
		if(user.isAadharNoCorrect(aadharNo))
		{
			...
			if(user.isMobileNoCorrect(mobileNo))
			{
